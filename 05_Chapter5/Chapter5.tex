...
The code in Listing \ref{code:metadata} contains metadata about the program and is not displayed on the pendant display. This metadata is generated by the post processor method \inline{ProgFinish}.
